...
- **Code/commits/PRs:** Maintain normal, professional standards for commit messages and PR descriptions. Commit messages are a single line — no body, and no `Co-Authored-By` or author trailers.
